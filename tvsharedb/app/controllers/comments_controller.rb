class CommentsController < ApplicationController
  ...
  def create
    @show = get_show
    @comment = @current_user.comments.new(text: comment_params[:text], show_id: @show.id, images: comment_params[:images], videos: comment_params[:videos])
  ...
  private
    ...
    def comment_params
      params.require(:comment).permit(:text, :hashtag, :show_id, images: [], videos: [])
    end
end
