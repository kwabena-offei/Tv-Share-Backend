...
const { Header, Content, Footer } = Layout; // or 'antd/dist/antd.less'
    ...
    <Layout className="layout">
      <Header>
        ...
        <Menu theme="dark" mode="horizontal" defaultSelectedKeys={['home']}>
          ...
          {categories.map((category, i) => <Menu.Item key={i} onClick={() => setSelectedCategory(category)}>{category.title}</Menu.Item>)}
        </Menu>
      </Header>
