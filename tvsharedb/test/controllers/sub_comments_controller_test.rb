...
class SubCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_comment" do
    assert_difference('SubComment.count') do
      post sub_comments_url, params: { sub_comment: { comment_id: @sub_comment.comment_id, hashtag: @sub_comment.hashtag, text: @sub_comment.text, user_id: @sub_comment.user_id } }, as: :json
    end
  ...
  test "should update sub_comment" do
    patch sub_comment_url(@sub_comment), params: { sub_comment: { comment_id: @sub_comment.comment_id, hashtag: @sub_comment.hashtag, text: @sub_comment.text, user_id: @sub_comment.user_id } }, as: :json
    assert_response 200
  end
