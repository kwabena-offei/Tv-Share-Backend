...
class ProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get reactions" do
    ...
    assert_equal %w(id text hashtag user_id created_at updated_at show_id images likes_count sub_comments_count videos shares_count), response.parsed_body['results'].first.keys
  end
